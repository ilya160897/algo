...
TEST_CASE("TEST_1") {
    REQUIRE(3 == MaximumSubsequence(4, {5, 2, 4, 1})());
}
TEST_CASE("TEST_2") {
    REQUIRE(19 == MaximumSubsequence(20, {199, 41, 299})());
}
TEST_CASE("TEST_3") {
